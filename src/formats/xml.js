...
function formatModule(indentation, report) {
    var i,
        functions = "",
        nextIndentation = incrementIndentation(indentation);
    ...
    return createElementWithAttributes(
        ...
        createElement(
            ...
            formatAggregate(nextIndentation, report.aggregate) +
            functions
    );
}
...
function formatSlocMetrics(indentation, data) {
    return (
        createElement(indentation, "physical", false, data.physical) +
...
function formatHalsteadMetrics(indentation, data) {
    return (
        createElement(indentation, "length", false, data.length) +
